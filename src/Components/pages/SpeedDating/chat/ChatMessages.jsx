...
import { FaCommentDots, FaQuestionCircle, FaUser } from "react-icons/fa";
import { Avatar } from "antd";

const ChatMessages = ({ messages, activeParticipant }) => {
  return (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-end space-x-3">
                    ...
                    <img
                      src={
                        msg.currentUser?.avatar ||
                        "https://randomuser.me/api/portraits/men/1.jpg"
                      }
                      alt={msg.currentUser?.username}
                      className="w-8 h-8 rounded-full"
                    />
                  </div>
                </div>
